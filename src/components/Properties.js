...
export class HTMLProperties extends Component {
      ...
      retData.push(
        <div key={`options-${i}`} className="d-block mb-3">
          <div className="d-inline-block w-100 align-top">
            ...
            <div className="d-inline-block align-top w-25 pl-1">
              {row.isChecked &&
                formContent.type === componentType.CHECK_BOX && (
                  <div className="form-check">
                    <input
                      type="checkbox"
                      className="form-check-input"
                      checked={row.isChecked}
                      onChange={(e) => this.handleoptioanschecked(i, e)}
                    />
                  </div>
                )}
              {formContent.type === componentType.RADIO && (
                <div className="form-check">
                  <input
                    ...
                    onChange={(e) => this.onChangeradioState(i, e)}
                    className="form-check-input"
                  />
                </div>
              )}
              <div className="d-inline-block w-25 align-top">
                <button className="btn text-primary">
                  <i
                    ...
                    onClick={(e) => this.onClickRemoveFormData(i, e)}
                  ></i>
                </button>
              </div>
            </div>
  ...
  addNewOption = () => {
    ...
    formContent.options.push({
      label: `Item ${formContent.options.length + 1}`,
        ...
        <div key={`validations-${i}`} className="d-block mb-3">
          <div className="d-inline-block w-75 align-top">
            <div className="d-inline-block w-50 pr-1">
              <input
                ...
                value={row.regEx}
                onChange={(e) => this.handleChangeValidationContent(e, i)}
              />
            </div>
          ...
          <div className="d-inline-block w-25 align-top">
            <button className="btn text-primary">
              <i
                className="fa fa-times"
                onClick={(e) => this.onClickRemoveValidationData(i, e)}
              ></i>
            </button>
          </div>
        </div>
      ...
      <div>
        <div className="d-block">
          ...
          <div>
            ...
            {(formContent.type === componentType.TEXT ||
              formContent.type === componentType.TEXT_AREA) && (
              <div className="form-group">
          ...
          {(formContent.type === componentType.RADIO ||
            formContent.type === componentType.CHECK_BOX ||
            formContent.type === componentType.SELECTBOX) && (
            <div>
              ...
              <div className="form-group">
                ...
                {this.renderOptions()}
                <button className="btn btn-primary" onClick={this.addNewOption}>
                  Add New
                </button>
              </div>
            </div>
