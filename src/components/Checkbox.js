      ...
      retData.push(
        <div key={`check-${i}`} className="form-check">
          <input
            ...
            onChange={(e) => this.onChangecheckboxState(i, e)}
          />
          {!option.isEdit && (
          ...
          {option.isEdit && (
            <input
              type="text"
              value={option.label}
              onChange={(e) => this.onChangeOption(i, e)}
              onBlur={(e) => this.onBlurOption(i, e)}
            />
          )}
          <a
            href={void 0}
            className="d-inline-block ml-2"
            onClick={(e) => this.onClickEditOption(i, e)}
          >
          ...
          <a
            href={void 0}
            className="d-inline-block ml-2"
            onClick={(e) => this.onClickCopyOption(i, e)}
          >
          ...
          <a
            href={void 0}
            className="d-inline-block ml-2"
            onClick={(e) => this.onClickRemoveOption(i, e)}
          >
