...
export class RadioGroup extends Component {
    ...
    for (let j = 0; j < options.length; j++) {
      ...
      retData.push(
        <div key={`check-${j}`} className="form-check">
          <input
            type="radio"
            name={`radiodata-${radioindex}`}
            checked={value.indexOf(option.value) !== -1}
            onClick={(e) => this.onChangeradioState(j, e)}
          ...
          {option.isEdit && (
            <input
              type="text"
              value={option.label}
              onChange={(e) => this.onChangeOption(j, e)}
              onBlur={(e) => this.onBlurOption(j, e)}
            />
          )}
          <a href={void 0} className="d-inline-block ml-2">
            <i
              className="fa fa-edit"
              onClick={(e) => this.onClickEditOption(j, e)}
            ></i>
          </a>
          <a href={void 0} className="d-inline-block ml-2">
            <i
              className="fa fa-copy"
              onClick={(e) => this.onClickCopyOption(j, e)}
            ></i>
          </a>
          <a href={void 0} className="d-inline-block ml-2">
            <i
              className="fa fa-times"
              onClick={(e) => this.onClickRemoveOption(j, e)}
            ></i>
          </a>
        </div>
      );
  ...
  render() {
    ...
    return (
      <div
        className={`d-block mb-4 question-container ${
          isActive ? "active" : ""
        }`}
      >
        <div className="d-block text-right pr-4 pb-1">
          <a href={void 0} className="float-left">
          ...
          <div className="d-inline-block">
            <a href={void 0}>
              ...
              <b onClick={() => this.setProperties({})}>Properties</b>{" "}
        ...
        <div className="d-block p-3 question-container-inner">
          <div
            className={`pb-3 question-heading ${
              editTitle ? "d-none" : "d-block"
            }`}
          >
            {title}
            {isRequired && <span>*</span>}
            &nbsp;
            <a href={void 0} onClick={this.onClickEditTitle}>
              <i className="fa fa-edit"></i>
            </a>
          </div>
          <div
            className={`pb-3 question-heading ${
              editTitle ? "d-block" : "d-none"
            }`}
          >
            <input
              type="text"
          ...
          <div className="form-group pt-3">
            <a href={void 0} className="d-inline-block mr-3">
              <i className="fa fa-plus" onClick={this.onClickAddOption}></i>
            </a>
          </div>
